...
def classifier_logistic(features, targets):
    ...
    with open("C:/data/serialized/lr_v2.p", "wb") as f:
        pickle.dump(lr, f)
...
def classifier_randomforest(features, targets):
    ...
    # Serialize the model
    with open("C:/data/serialized/rf_v2.p", "wb") as f:
        pickle.dump(lr, f)
...
def classifier_lda(features, targets):
    ...
    # Serialize the model
    with open("C:/data/serialized/lda_v3.p", "wb") as f:
        pickle.dump(lda, f)
...
def classifier_qda(features, targets):
    ...
    # Serialize the model
    with open("C:/data/serialized/qda_v2.p", "wb") as f:
        pickle.dump(qda, f)
...
if __name__ == '__main__':
    ...
    with open("C:/data/serialized/bow_v2.p", "rb") as f:
        bag_of_words = pickle.load(f)
    # Labels of the dataset
    with open("C:/data/serialized/labels_v2.p", "rb") as f:
