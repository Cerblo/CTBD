...
def classifier_logistic(features, targets):
    ...
    with open("C:/data/serialized/lr.p", "wb") as f:
        pickle.dump(lr, f)
...
def classifier_randomforest(features, targets):
    ...
    # Serialize the model
    with open("C:/data/serialized/rf.p", "wb") as f:
        pickle.dump(lr, f)
...
if __name__ == '__main__':
    ...
    with open("C:/data/serialized/bow.p", "rb") as f:
        bag_of_words = pickle.load(f)
    # Labels of the dataset
    with open("C:/data/serialized/labels.p", "rb") as f:
